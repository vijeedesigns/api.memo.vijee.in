...
const uploadPath = appDir + `\\..\\public\\uploads\\`;
const payslipsPath = appDir + `\\..\\public\\payslips\\`;
...
module.exports = { algorithm, key, iv, plainText, secretKey, uploadPath, payslipsPath, imageNotFound, eventTypes };